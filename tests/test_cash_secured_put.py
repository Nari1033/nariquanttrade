...
class TestCashSecuredPutBacktester(unittest.TestCase):
    ...
    def test_entry_day_of_month_zero_matches_unfiltered_baseline(self):
        ...
        baseline = backtest_cash_secured_put(self.bars, ticker="TREND")
        filtered = backtest_cash_secured_put(self.bars, ticker="TREND", entry_day_of_month=0)
        self.assertEqual(
    ...
    def test_entry_day_of_month_restricts_every_entry_to_the_window(self):
        target = 10
        result = backtest_cash_secured_put(self.bars, ticker="TREND", entry_day_of_month=target)
    ...
    def test_narrow_entry_window_trades_less_than_unfiltered(self):
        ...
        baseline = backtest_cash_secured_put(self.bars, ticker="TREND")
        filtered = backtest_cash_secured_put(self.bars, ticker="TREND", entry_day_of_month=15)
